...
public class _02_FindTheHiddenButton implements ActionListener {
	...
	public void start() {
		...
		JOptionPane.showMessageDialog(null, "You must click the right button out of the buttons given. or else...");
		// 13. initialize the hiddenButton variable to a random number less than the int
		// created in step 3
		Random rando = new Random();
		hiddenbutton = rando.nextInt(answerr);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == buttons[hiddenbutton]) {
			...
			JOptionPane.showMessageDialog(null, "try again you poo!");
		}
